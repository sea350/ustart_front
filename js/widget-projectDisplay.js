$(function() {
	$("#projectDisplayModal button.projectsColumn").click(function() {
		...
		if ("true" === isVisible) {
			...
			$("#proj-preview" + $(this).attr("data-project")).parents(".projectsColumn").attr("data-project-visible", "false");
			$.ajax({
				type: 'GET',  
				...
				failure: function(error) {
					...
					$("#proj-preview" + $(this).attr("data-project")).parents(".projectsColumn").attr("data-project-visible", "true");
				}
			});
		} else {
			$(this).attr("data-project-visible", "true");

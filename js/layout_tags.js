...
function createTagWidgetElement(element, tag) {
    var tagspan = $('<button/>').attr({'id': 'skill-'+ tag, 'class': 'btn btn-default projectsColumn'}).click(function() {
        window.location.href='https://k12start.today:'+window.location.port+'/search?query=&searchFilterGroup=projects&sortbyfilter=relevance&searchbyprojectname=true&searchbyurl=true&searchbyskills=true&searchbylocationcountry=&usersearchlocationcountry=United+States&usersearchlocationstate=&usersearchlocationstate=NY&searchlistmajors=%5D&searchlistskills=%5B%22'+tag+'%22%5D'
    });
...
function createProjectTagWidgetElement(element, tag) {
    var tagspan = $('<button/>').attr({'id': 'skill-'+ tag, 'class': 'btn btn-default projectsColumn'}).click(function() {
        window.location.href='https://k12start.today:'+window.location.port+'/search?query=&searchFilterGroup=users&sortbyfilter=relevance&searchbyprojectname=true&searchbyurl=true&searchbyskills=true&searchbylocationcountry=&usersearchlocationcountry=United+States&usersearchlocationstate=&usersearchlocationstate=NY&searchlistmajors=%5D&searchlistskills=%5B%22'+tag+'%22%5D'
    });
    var colDiv = $('<div />').attr({'class': 'columnImage'});
    var colTitle = $('<div />').attr({'class': 'columnTitle'}).text(tag);
    colDiv.append(colTitle);
...
$(document).ready(function () {
    ...
    $('#tag-submit').click(function(e) {
        ...
        $.ajax({
            type: 'GET',  
            url: 'https://k12start.today:'+port+'/addSkill/',
    ...
    $('#tag-project-submit').click(function(e) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://k12start.today:'+port+'/UpdateProjectTags/',
            contentType: "application/json; charset=utf-8",
    ...
    $('#wantedSkill-project-submit').click(function(e) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://k12start.today:'+port+'/UpdateProjectWantedSkills/',
            contentType: "application/json; charset=utf-8",

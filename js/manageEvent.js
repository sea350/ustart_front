...
$(document).ready(function () {
   ...
   $('.eventList').on( "click", function(e) {
	   ...
	   $.ajax({
		   type: 'GET',
		   url: 'http://ustart.today:'+port+'/LoadGuestJoinRequests/',
   ...
   $('body').on("click", ".y-btn", function(e) {
      ...
      $(this).prop('disabled', true);
	   ...
	   $.ajax({
		   type: 'GET',
		   url: 'http://ustart.today:'+port+'/AcceptGuestJoinRequest/',
		   contentType: "application/json; charset=utf-8",
   ...
   $('body').on("click", ".x-btn", function(e) {
	   ...
	   that.off('click'); // remove handler
		$.ajax({
		   type: 'GET',
		   url: 'http://ustart.today:'+port+'/RejectEventGuestJoinRequest/',
		   contentType: "application/json; charset=utf-8",

    ...
    function makePostApplications(image, fName,lName, content, elementID,numLikes,numReplies,numShares ,time){
        ...
        /*--- append main modal ---- */
        $('#commentModals').append('<div class="modal fade" id="main-modal'+elementID+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><div class="media"> <a class="pull-left" href="#"><img class="media-object img-rounded" id="comment-img'+elementID+'" src=""> </a><div class="media-body"><h6 class="pull-right text-muted time">'+timeSince(time)+'</h6><h5 class="mt-0" style="color:cadetblue;">'+fName+" "+lName+'</h5><p>'+readRuneArrayThatWorks(content)+'</p></div></div></div><div class="modal-body"><div class="input-group"><textarea style="resize: none;" class="form-control" id="commentContent'+elementID+'" name="commentz" placeholder="Add a comment" aria-label="With textarea"></textarea><span class="input-group-addon new-comment-submit" id="'+elementID+'"><i class="fa fa-edit"></i></span></div><br><div class ="comment-lists" id="comments-list'+elementID+'"></div>');
